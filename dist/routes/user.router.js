...
router.post("/register", (0, validator_handler_1.validatorHandler)(user_schema_1.createUserSchema, "body"), user_controller_1.userRegister);
router.post("/login", (0, validator_handler_1.validatorHandler)(user_schema_1.createUserSchema, "body"), user_controller_1.userLogin);
...
router.delete("/:id", (0, validator_handler_1.validatorHandler)(user_schema_1.getUserSchema, "params"), user_controller_1.deleteUser);
